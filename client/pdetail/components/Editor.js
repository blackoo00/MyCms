...
class Test extends React.Component {
    ...
    // }
    render() {
        const {content,editCon} = this.props;
        const uploadConfig = {
            QINIU_URL: "http://127.0.0.1/my-store/index.php/Back/Store/upload", //上传地址，现在暂只支持七牛上传
            QINIU_IMG_TOKEN_URL: "http://127.0.0.1/my-store/index.php/Back/Store/token", //请求图片的token
            QINIU_PFOP: {
